...
def alpha_filt(unique_graph_indicator, graph_indicators, df_edges, step_size, dataset,
    ...
    for graph_id in unique_graph_indicator:
        try:
            ...
            filename = "/home/taiwo/projects/def-cakcora/taiwo/Apr2023/persistentDiagram/" + dataset + str(
                step_size) + "pbettig0.txt"
            with open(filename, "a") as f:
                f.write(f"{graph_id}: {dgm_0}\n")
            ...
            betti_list.append(
                [dataset] + [graph_id] + graph_label + [filtr_time] + betti_0)  # concatenate betti numbers
    ...
    feature_data.to_csv(
        "/home/taiwo/projects/def-cakcora/taiwo/Apr2023/result/filtration/" + dataset + str(
            step_size) + "_alpha_pcabettig0.csv", index=False)
