...
if __name__ == "__main__":
    datapath = "/project/def-cakcora/taiwo/Apr2023/result/resistanceFiltration"
    ...
    outputfile = "/project/def-cakcora/taiwo/Apr2023/result/randomForest/rfResistanceFiltration.csv"
